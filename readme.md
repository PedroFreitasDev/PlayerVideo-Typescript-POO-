Projeto de player de vídeo implementado em TypeScript, utilizando Programação Orientada a Objetos na disciplina de Estrutura de Dados do 4 modulo de Ciencia da Computação 
